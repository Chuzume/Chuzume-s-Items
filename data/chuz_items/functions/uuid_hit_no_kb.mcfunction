...
# オーナーのUUIDをコピー
    data modify entity @e[type=minecraft:area_effect_cloud,tag=Chuz_UUID_Hit,limit=1,sort=nearest] Owner set from entity @e[tag=Chuz.UUIDAttack,limit=1,sort=nearest] data.ChuzData.Owner
