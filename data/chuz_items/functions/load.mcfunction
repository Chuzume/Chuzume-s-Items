...
# スコアボード作成
    ...
    scoreboard objectives add ChuzItems.Combo dummy
    scoreboard objectives add ChuzItems.ComboWait dummy
    scoreboard objectives add ChuzItems.Rotation dummy
    scoreboard objectives add ChuzItems.RotSpeed dummy
    scoreboard objectives add ChuzItems.RotDistance dummy
