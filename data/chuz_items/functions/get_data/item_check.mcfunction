...
# 最新のものかチェックし、最新じゃなければ取得
    ...
    #execute if score $NotLatestData Chuz.Temporary matches 1 run function chuz_items:get_data/item_check
    ...
    execute if score $NotLatestData Chuz.Temporary matches 1 store success score @s Chuz.ItemCheck run data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].OldMainhand set from storage chuz:context Item.Mainhand