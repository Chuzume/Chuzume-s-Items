...
# 手持ち情報削除、アイテム入れ替え
    ...
    item replace entity @s weapon.mainhand with warped_fungus_on_a_stick{display:{Name:'[{"text":"Craftsman Shotgun","color":"aqua","italic":false},{"text":" | Reloading |","color":"gray","italic":false}]',Lore:['{"text":" "}','{"text":"[RClick: Just Reload]","color":"white","italic":false}','{"text":"[Ammo: Shotshell]","color":"white","italic":false}','{"text":" "}','{"text":"\\"連打じゃダメだぞ\\"","color":"gray","italic":false}']},HideFlags:4,Unbreakable:1b,CustomModelData:13,ChuzData:{NoOffhand:true,ItemID:Craftsman_Shotgun_Reload}} 1
