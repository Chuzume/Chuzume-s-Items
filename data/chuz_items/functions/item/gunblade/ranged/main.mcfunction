...
# 発砲
    execute unless score @s[scores={ChuzItems.Crossbow=0..}] ChuzItems.Charge matches 30.. unless score @s ChuzItems.CoolTime matches 0.. unless data storage chuz:context Item.Mainhand.tag.ChuzData{Ammo:0} anchored eyes positioned ^ ^ ^ run function chuz_items:item/gunblade/ranged/fire/normal
    # 残弾0なら失敗
...
# チャージ
    ...
    # チャージショット
        execute if score @s[scores={ChuzItems.Crossbow=0..}] ChuzItems.Charge matches 30.. unless data storage chuz:context Item.Mainhand.tag.ChuzData{Ammo:0} run function chuz_items:item/gunblade/ranged/fire/chargeshot
    # 弾切れ
        execute if score @s[scores={ChuzItems.Crossbow=0..}] ChuzItems.Charge matches 30.. if data storage chuz:context Item.Mainhand.tag.ChuzData{Ammo:0} run function chuz_items:item/gunblade/ranged/fire/out_of_ammo
