#> chuz_items:item/gunblade/ranged/recoil/main
#
# リコイル
#
...
# リコイル
    ...
    execute if entity @s[scores={ChuzItems.Recoil.Gunblade=5..}] at @s run function chuz_items:item/gunblade/ranged/recoil/start_return
