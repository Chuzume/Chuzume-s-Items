...
# 火薬パワーでなんか吹っ飛ばす
    execute positioned ^ ^ ^2.5 as @e[type=!#chuz_items:unhurtable,tag=!This,nbt=!{Invulnerable:1b},distance=..2] at @s facing entity @p[tag=This] feet run function chuz_items:item/gunblade/melee/charge_smash/hit
    execute positioned ^ ^ ^6 as @e[type=!#chuz_items:unhurtable,tag=!This,nbt=!{Invulnerable:1b},distance=..2] at @s facing entity @p[tag=This] feet run function chuz_items:item/gunblade/melee/charge_smash/hit
