...
# 弾薬消費ONなら弾を一個減らす。減らすのに成功したら装填カウントを1増やす
    execute if score $ChuzItems.Setting1 Chuz.Rule matches 1 store success score $ConsumeSuccess Chuz.Temporary run function chuz_items:common/reload/check_ammo_type
