...
# リロードの開始を宣言
    execute if data storage chuz:context {Reload:1} as @p[tag=This] run function chuz_items:common/reload/check_have_ammo
    execute if data storage chuz:context {Reload:1} as @p[tag=This] run function chuz_items:item/replaceitem
