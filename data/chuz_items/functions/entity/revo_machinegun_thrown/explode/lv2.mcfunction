#> chuz_items:entity/revo_machinegun_thrown/explode/lv2
#
# 中爆発
#
...
# ダメージを与える
    execute positioned ~-0.5 ~-0.5 ~-0.5 at @e[type=!#chuz_items:unhurtable,tag=!Chuz.PlayerShouldInvulnerable,tag=!Chuz.Uninterferable,nbt={Invulnerable:0b},dx=0] as @e[type=!#chuz_items:unhurtable,tag=!Chuz.PlayerShouldInvulnerable,tag=!Chuz.Uninterferable,nbt={Invulnerable:0b},distance=..2] at @s run function csr_score_damage:api/attack
