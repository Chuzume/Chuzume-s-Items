...
# ダメージを与える
    execute positioned ~-0.5 ~-0.5 ~-0.5 at @e[type=!#chuz_items:unhurtable,nbt={Invulnerable:0b},dx=0] as @e[type=!#chuz_items:unhurtable,nbt={Invulnerable:0b},distance=..2] at @s run function csr_score_damage:api/attack
