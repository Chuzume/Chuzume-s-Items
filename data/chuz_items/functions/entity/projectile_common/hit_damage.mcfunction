...
# ヘッドショットチェック
    execute anchored eyes positioned ^ ^ ^ positioned ~-0.5 ~-0.5 ~-0.5 if entity @e[type=marker,tag=S.Rif_Projectile,dx=0] run function chuz_items:entity/projectile_common/hit_headshot
