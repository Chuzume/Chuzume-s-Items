...
# 回転
    ...
    execute if score @s Test matches 0..4 run scoreboard players remove @s ChuzItems.RotSpeed 3
    execute if score @s Test matches 5..10 run scoreboard players remove @s ChuzItems.RotSpeed 5
    execute if score @s Test matches 11.. run scoreboard players set @s ChuzItems.RotSpeed -30
    execute if score @s Test matches 25.. run scoreboard players set @s ChuzItems.RotSpeed -10
...
# 進んだ距離
    ...
    tag @s[scores={ChuzItems.RotDistance=..-580}] add ChuzItems.Kill

# 回転速度
    #execute store result score @s ChuzItems.Rotation run data get entity @s Pose.Head[0] 1
    scoreboard players operation @s ChuzItems.Rotation += @s ChuzItems.RotSpeed
    #execute store result entity @s Pose.Head[0] float 1 run scoreboard players get @s ChuzItems.Rotation
