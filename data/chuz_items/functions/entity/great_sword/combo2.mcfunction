...
# 回転
    ...
    execute if score @s Test matches 0..4 run scoreboard players add @s S.Rif_RotSpeed 3
    execute if score @s Test matches 5..10 run scoreboard players add @s S.Rif_RotSpeed 5
