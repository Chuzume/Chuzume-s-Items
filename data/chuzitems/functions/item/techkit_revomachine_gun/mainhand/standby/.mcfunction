...
# 発砲
    ...
    # ADS
        execute unless score @s[scores={ChuzItems.Crossbow=0..},predicate=chuzitems:sneak] ChuzItems.CoolTime matches 0.. unless data storage chuz:context Item.Mainhand.tag.ChuzData{Ammo:0} run function chuzitems:item/techkit_revomachine_gun/mainhand/standby/shot/ads
    # 弾の召喚部分
