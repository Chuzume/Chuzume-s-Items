#> chuzitems:item/armor/directional_jump_boots/get
#
# 入手処理
#
...
# 実行者の位置にアイテムを召喚
    execute at @s run loot spawn ~ ~ ~ loot chuzitems:item/armor/directional_jump_boots
...
# 商品サンプルを削除
    clear @s iron_boots{ChuzData:{SellSample:1b}} 1
