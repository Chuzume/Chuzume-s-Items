#> chuzitems:item/craftsman_grenade_launcher/mainhand/standby/shot/summon
#
# 
#
# @within function chuzitems:item/craftsman_grenade_launcher/mainhand/standby/shot/**
...
# 弾を召喚
    ...
    execute at @s run function chuzitems:item/craftsman_grenade_launcher/mainhand/standby/shot/spread