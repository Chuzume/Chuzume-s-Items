...
# 手持ち情報削除、アイテム入れ替え
    ...
    item replace entity @s weapon.mainhand with warped_fungus_on_a_stick{display:{Name:'[{"text":"Craftsman Grenade Launcher","color":"aqua","italic":false},{"text":" | Reloading |","color":"gray","italic":false}]',Lore:['{"text":" "}','{"text":"[Ammo: Explosive Cartridge]","color":"white","italic":false}','{"text":" "}','{"text":"\\"おっきな弾を装填\\"","color":"gray","italic":false}']},HideFlags:4,Unbreakable:1b,CustomModelData:14,ChuzData:{NoOffhand:1b,NoDrop:1b,ItemID:Craftsman_Grenade_Launcher_Reload}} 1
