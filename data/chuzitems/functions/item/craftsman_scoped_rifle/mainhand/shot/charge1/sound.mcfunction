#> chuzitems:item/craftsman_scoped_rifle/shot/charge1/sound
#
# 
#
# @within function chuzitems:item/craftsman_scoped_rifle/shot/charge1/
...
playsound minecraft:entity.blaze.hurt player @a ~ ~ ~ 5 0.8