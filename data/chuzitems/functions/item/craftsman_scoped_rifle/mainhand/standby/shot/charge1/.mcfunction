...
# 弾を召喚
    # 腰だめ
        ...
        execute if entity @s[tag=!Chuz.UsingSpyglass] positioned ^-0.25 ^ ^ summon marker run function chuzitems:item/craftsman_scoped_rifle/mainhand/standby/shot/charge1/init
    # スコープ！
        ...
        execute if entity @s[tag=Chuz.UsingSpyglass] positioned ^ ^ ^ summon marker run function chuzitems:item/craftsman_scoped_rifle/mainhand/standby/shot/charge1/init
