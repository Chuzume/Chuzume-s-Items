#> chuzitems:item/photon_glaive/common/charge/1
#
# 
#
...
# サウンド
    playsound chuzume:cyber19_1 player @s ~ ~ ~ 1 1.5
    playsound minecraft:block.note_block.bit player @a ~ ~ ~ 1.5 1
    playsound minecraft:block.iron_trapdoor.open player @a ~ ~ ~ 1 1.5