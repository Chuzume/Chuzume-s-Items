#> chuzitems:item/mozambique/gun/shot/ads
#
# 
#
...
# 弾を召喚
    # 上
        summon marker ^ ^ ^ {Tags:["Chuz.Projectile","ChuzItems.RecursiveBullet","ChuzItems.Projectile.Mozambique","Chuz.UUIDAttack","Chuz.Init"],data:{ChuzData:{BodyDamage:2.5,HeadDamage:4.0,Speed:10,Range:200,Spread:0.0f}}}
