...
# 発砲
    ...
    # 腰だめ
        execute unless score @s[scores={ChuzItems.Crossbow=0..,ChuzItems.Sneak=1..}] ChuzItems.CoolTime matches 0.. unless data storage chuz:context Item.Mainhand.tag.ChuzData{Ammo:0} anchored eyes run function chuzitems:item/mozambique/mainhand/standby/shot/
    # ADS
        execute unless score @s[scores={ChuzItems.Crossbow=0..}] ChuzItems.CoolTime matches 0.. unless score @s ChuzItems.Sneak matches 1.. unless data storage chuz:context Item.Mainhand.tag.ChuzData{Ammo:0} anchored eyes run function chuzitems:item/mozambique/mainhand/standby/shot/ads
