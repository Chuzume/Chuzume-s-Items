#> chuzitems:item/craftsman_gunblade/mainhand/ranged/shot/
#
# 
#
...
# 弾を召喚
    execute if entity @s[tag=ChuzItems.Gunblade.NormalShot] positioned ^-0.25 ^ ^ summon marker run function chuzitems:item/craftsman_gunblade/mainhand/ranged/shot/init/charge0
    execute if entity @s[tag=ChuzItems.Gunblade.FullBurst] positioned ^-0.25 ^ ^ summon marker run function chuzitems:item/craftsman_gunblade/mainhand/ranged/shot/init/charge1
