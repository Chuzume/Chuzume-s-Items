#> chuzitems:item/wingman/reload/finish
#
# リロード完了
#
# @within function chuzitems:item/wingman/reload/reloading

# アイテムを渡す
    loot replace entity @s weapon.mainhand loot chuzitems:item/wingman/
