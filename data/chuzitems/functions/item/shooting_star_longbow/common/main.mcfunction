...
# スニークでロックオン
    execute unless score @s ChuzItems.ShootingStar.LockDelay matches 0.. if score @s ChuzItems.ShootingStar.LockCount matches ..10 if predicate chuzitems:sneak anchored eyes positioned ^ ^ ^ run function chuzitems:item/shooting_star_longbow/common/lockon/
