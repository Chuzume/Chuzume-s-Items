#> chuzitems:item/craftsman_shotgun/mainhand/shot/
#
# 
#
...
# 発砲
    execute positioned ^ ^-0.2 ^1.0 run function chuzitems:item/craftsman_shotgun/mainhand/shot/sound

# 弾を召喚
    particle smoke ^-0.25 ^ ^0.7 0 0 0 0.05 10
    execute positioned ^-0.25 ^ ^ summon marker run function chuzitems:item/craftsman_shotgun/mainhand/shot/init
    execute positioned ^-0.25 ^ ^ summon marker run function chuzitems:item/craftsman_shotgun/mainhand/shot/init
    execute positioned ^-0.25 ^ ^ summon marker run function chuzitems:item/craftsman_shotgun/mainhand/shot/init
    execute positioned ^-0.25 ^ ^ summon marker run function chuzitems:item/craftsman_shotgun/mainhand/shot/init
    execute positioned ^-0.25 ^ ^ summon marker run function chuzitems:item/craftsman_shotgun/mainhand/shot/init
