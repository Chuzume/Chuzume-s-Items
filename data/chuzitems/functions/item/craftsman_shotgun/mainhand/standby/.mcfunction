#> chuzitems:item/craftsman_shotgun/mainhand/standby/
#
# 
#
...
# 発砲
    execute if entity @s[scores={ChuzItems.Crossbow=0..}] unless data storage chuz:context Item.Mainhand.tag.ChuzData{Ammo:0} anchored eyes positioned ^ ^ ^ run function chuzitems:item/craftsman_shotgun/mainhand/standby/shot/
