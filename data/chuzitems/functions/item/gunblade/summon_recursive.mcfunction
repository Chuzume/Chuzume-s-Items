...
# スライムを召喚
    ...
    execute if score @s ChuzItems.Recursive matches 0.. run function chuzitems:item/gunblade/summon_recursive

# ちょっとした後戻す
    schedule function chuzitems:item/gunblade/melee/return_gamerule 2t