#> chuzitems:item/ender_glaive/common/throw
#
# 
#
...
# Init処理
    execute as @e[type=armor_stand,tag=ChuzItems.Projectile.EnderGlaive,tag=Chuz.Init,sort=nearest,limit=1] at @s run function chuzitems:item/ender_glaive/common/init
