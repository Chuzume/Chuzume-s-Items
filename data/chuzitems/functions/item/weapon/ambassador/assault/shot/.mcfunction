#> chuzitems:item/weapon/ambassador/assault/shot/
#
# 
#
...
# 演出
    execute positioned ^ ^-0.4 ^1.0 run function chuzitems:item/weapon/ambassador/assault/shot/sound
...
# 弾を召喚
    execute if entity @s[tag=ChuzItems.Shot.Normal] positioned ^-0.25 ^ ^ summon marker run function chuzitems:item/weapon/ambassador/assault/shot/init
    execute if entity @s[tag=ChuzItems.Shot.ADS] positioned ^ ^ ^ summon marker run function chuzitems:item/weapon/ambassador/assault/shot/init
