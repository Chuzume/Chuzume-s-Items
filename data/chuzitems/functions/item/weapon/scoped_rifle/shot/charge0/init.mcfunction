#> chuzitems:item/weapon/scoped_rifle/shot/charge0/init
#
# Init処理
#
# @within function chuzitems:item/weapon/scoped_rifle/shot/charge0
...
## 弾のステータスを設定
    # ダメージ(ボディ)
        data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Projectile.BodyDamage set value 7.0
    # ダメージ(ヘッド)
        data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Projectile.HeadDamage set value 14.0
    # 弾速
