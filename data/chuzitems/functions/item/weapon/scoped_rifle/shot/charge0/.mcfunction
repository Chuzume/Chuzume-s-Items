#> chuzitems:item/weapon/scoped_rifle/shot/charge0/
#
# チャージ0射撃
#
...
# サウンド
    execute positioned ^ ^-0.2 ^1.0 run function chuzitems:item/weapon/scoped_rifle/shot/charge0/sound

# 弾を召喚
    # 腰だめ
        execute if entity @s[tag=!Chuz.UsingSpyglass] run particle smoke ^-0.25 ^ ^0.7 0 0 0 0.05 5
        execute if entity @s[tag=!Chuz.UsingSpyglass] positioned ^-0.25 ^ ^ summon marker run function chuzitems:item/weapon/scoped_rifle/shot/charge0/init
    # スコープ！
        ...
        execute if entity @s[tag=Chuz.UsingSpyglass] positioned ^ ^ ^ summon marker run function chuzitems:item/weapon/scoped_rifle/shot/charge0/init
