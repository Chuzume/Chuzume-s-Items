#> chuzitems:item/weapon/mozambique/reload/reloading
#
# リロードモードのメイン処理
#
...
# スコア増やしてく、一定値で終了
    ...
    execute if score @s ChuzItems.Reload matches 50.. run function chuzitems:item/weapon/mozambique/reload/finish
