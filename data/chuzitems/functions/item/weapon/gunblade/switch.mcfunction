...
# 銃から剣に
    execute if data storage chuz:context Item.Offhand.tag.ChuzData{ItemID:Craftsman_Gunblade,ItemMode:Ranged} run loot replace entity @s weapon.offhand loot chuzitems:item/weapon/gunblade/melee

# 剣から銃に
    execute if data storage chuz:context Item.Offhand.tag.ChuzData{ItemID:Craftsman_Gunblade,ItemMode:Melee} run loot replace entity @s weapon.offhand loot chuzitems:item/weapon/gunblade/ranged
