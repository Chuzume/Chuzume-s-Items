...
# サウンド
    execute if entity @e[type=!experience_orb,tag=This,sort=nearest,limit=1] at @p[tag=Chuz.ID.Target] run playsound minecraft:entity.item.pickup neutral @p ~ ~ ~ 1 1
