...
# パーティクル
    ...
    # 燃えてないとき
        execute if entity @s[tag=!ChuzItems.Projectile.FlameArrow,scores={ChuzItems.Tick=2..}] run particle dust 1 1 1 1 ~ ~ ~ 0 0 0 0.0 1 force @a[distance=..120]
        execute if entity @s[tag=!ChuzItems.Projectile.FlameArrow] run particle dust 1 1 1 0.5 ~ ~ ~ 0 0 0 0.0 1 force @a[distance=..120]
    # 燃えているとき
        execute if entity @s[tag=ChuzItems.Projectile.FlameArrow,scores={ChuzItems.Tick=2..}] run particle dust 1 0.5 0 1 ~ ~ ~ 0 0 0 0.0 1 force @a[distance=..120]
        execute if entity @s[tag=ChuzItems.Projectile.FlameArrow] run particle dust 1 0.5 0 0.5 ~ ~ ~ 0 0 0 0.0 1 force @a[distance=..120]
