#> chuzitems:entity/projectile/photon_glaive/tick/catch
#
# 
#
...
# ブーメランを与える
    # メインハンド
        execute if entity @s[tag=!ChuzItems.Projectile.Glaive.Off] run loot replace entity @p[gamemode=!creative,tag=Chuz.ID.Target] weapon.mainhand loot chuzitems:item/photon_glaive
    # オフハンド
        execute if entity @s[tag=ChuzItems.Projectile.Glaive.Off] run loot replace entity @p[gamemode=!creative,tag=Chuz.ID.Target] weapon.offhand loot chuzitems:item/photon_glaive
