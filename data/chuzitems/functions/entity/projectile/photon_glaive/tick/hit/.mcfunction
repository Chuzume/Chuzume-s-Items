#> chuzitems:entity/projectile/photon_glaive/tick/hit/
#
# ダメージ
#
...
# 演出
    execute if score @s Chuz.HitCheck matches 1 as @e[type=!#chuzitems:unhurtable,sort=nearest,limit=1] unless entity @s[type=ender_dragon] at @s run function chuzitems:entity/projectile/photon_glaive/tick/hit/vfx
