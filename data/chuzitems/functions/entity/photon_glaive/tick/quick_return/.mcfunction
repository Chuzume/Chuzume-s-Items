#> chuzitems:entity/photon_glaive/tick/quick_return/
#
# 
#
...
# チャージ1の場合、爆発する
    execute if score @s ChuzItems.Projectile.Charge matches 1 run function chuzitems:entity/photon_glaive/tick/quick_return/discharge

# タグ付与
    tag @s add ChuzItems.PhotonGlaive.Recalled