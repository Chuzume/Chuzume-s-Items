...
# 飛距離0なら壁を無視するようになる
    execute if entity @s[scores={Chuz.Recursion=1..,Chuz.Range=..0}] at @s positioned ^ ^ ^0.1 run tp @s ~ ~ ~
...
# 再帰
    execute if entity @s[scores={Chuz.Recursion=1..,Chuz.Range=1..}] at @s run function chuzitems:entity/photon_glaive/tick/move/
