...
# 最新のものかチェックし、最新じゃなければ取得
    ...
    execute if score $NotLatestData Chuz.Temporary matches 1 unless data storage chuz:context Item.Mainhand.tag.ChuzData.ItemID run data modify storage chuz:context Item.Mainhand set value {}
