...
#> メッセージ表示
    ...
    # リコイルを有効化するか
        execute if score $Gamerule.Recoil Chuz.Rule matches 0 run tellraw @s ["",{"text":"武器のリコイルを有効化","hoverEvent":{"action":"show_text","contents":[{"text":"マルチプレイではオフ推奨","color":"white","italic":false}]}},{"text":" [ いいえ ]","color":"dark_red","hoverEvent":{"action":"show_text","contents":[{"text":"クリックで切り替え"}]},"clickEvent":{"action":"run_command","value":"/function chuzitems:setting/recoil"}}]
        execute if score $Gamerule.Recoil Chuz.Rule matches 1 run tellraw @s ["",{"text":"武器のリコイルを有効化","hoverEvent":{"action":"show_text","contents":[{"text":"マルチプレイではオフ推奨","color":"white","italic":false}]}},{"text":" [ はい ]","color":"green","hoverEvent":{"action":"show_text","contents":[{"text":"クリックで切り替え"}]},"clickEvent":{"action":"run_command","value":"/function chuzitems:setting/recoil"}}]
