...
# 火薬パワーでなんか吹っ飛ばす
    execute positioned ^ ^ ^2 as @e[type=!#craftsman_arms:unhurtable,tag=!Chuz.This,nbt=!{Invulnerable:1b},distance=..2] at @s rotated 0 ~ facing entity @p[tag=Chuz.This] feet run function craftsman_arms:item/gunblade/melee/charge_smash/hit
