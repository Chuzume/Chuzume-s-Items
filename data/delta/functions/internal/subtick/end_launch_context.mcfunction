...
summon minecraft:bat ~ ~12000 ~ {DeathLootTable:"",NoAI:1b,Tags:["delta.post_explosion","delta.bat"],PersistenceRequired:1b,DeathTime:19s,Health:2048f,Attributes:[{Name:generic.max_health,Base:2048}]}
